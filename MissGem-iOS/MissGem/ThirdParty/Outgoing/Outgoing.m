...
@interface Outgoing() <WKNavigationDelegate>
...
- (void)webView:(WKWebView *)webView didReceiveServerRedirectForProvisionalNavigation:(WKNavigation *)navigation {
    ...
    // Weibo OAuth
    if ([webView.URL.absoluteString.lowercaseString hasPrefix:[Outgoing keyFor:@"Weibo"][@"redirectURI"]]) {
        [webView stopLoading];
        ...
        [string appendFormat:@"client_id=%@", [Outgoing keyFor:@"Weibo"][@"appKey"]];
        [string appendFormat:@"&client_secret=%@", [Outgoing keyFor:@"Weibo"][@"appSecret"]];
        [string appendFormat:@"&grant_type=authorization_code&"];
        [string appendFormat:@"redirect_uri=%@", [Outgoing keyFor:@"Weibo"][@"redirectURI"]];
